...
export default function WinnerCelebration({ onClose }: { onClose?: () => void }) {
      ...
      {showCelebration && (
        ...
        >
          ...
          <motion.div 
            ...
            animate={{ opacity: 0.8 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 bg-gradient-to-br from-purple-900/30 to-orange-900/30 backdrop-blur-sm"
            onClick={handleClose}
          />
          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              ...
              {/* Content */}
              <div className="relative bg-gradient-to-br from-orange-500 to-yellow-500 text-white p-8 rounded-2xl overflow-hidden z-10">
                <button 
                  onClick={handleClose}
