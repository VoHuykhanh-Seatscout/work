...
export const Icons = {
  ...
  layout: (props: SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
...
play: (props: SVGProps<SVGSVGElement>) => (
  ...
  paperclip: (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
  ...
  drive: (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
      <path d="M7.71 3.5L1.15 15l4.58 7.94L16.54 22l6.47-11.5-4.49-7.79-10.81.79zM9.73 15l-2.15-3.72 7.02-.52 2.17 3.73-7.04.51zm5.85-10.7l4.53 7.82-2.15 3.73-7.03.51-2.14-3.72 6.79-8.34z" />
    </svg>
  ),
  figma: (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
      <path d="M15 5.5a3.5 3.5 0 1 1-4 3.465V12a3.5 3.5 0 1 1-4-3.465V5.5a3.5 3.5 0 1 1 4 0v3.535A3.5 3.5 0 0 1 15 5.5zM11 5.5A1.5 1.5 0 1 0 9.5 7 1.5 1.5 0 0 0 11 5.5zm0 6A1.5 1.5 0 1 0 9.5 13 1.5 1.5 0 0 0 11 11.5zm-4-6A1.5 1.5 0 1 0 5.5 7 1.5 1.5 0 0 0 7 5.5zm4 9.5a3.5 3.5 0 1 1-3.5-3.5H7a3.5 3.5 0 1 1 4 3.465zm0-1.5A1.5 1.5 0 1 0 9.5 19 1.5 1.5 0 0 0 11 17.5zm4-6A1.5 1.5 0 1 0 13.5 13 1.5 1.5 0 0 0 15 11.5z" />
    </svg>
  ),
