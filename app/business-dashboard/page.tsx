...
import { 
  Award, Users, BarChart2, PieChart, Calendar, Mail, UserPlus, Rocket, 
  Sword, Trophy, Mic, Smile, Palette, Code, Lightbulb, TrendingUp
} from "lucide-react";
  ...
  <div className="space-y-6">
    {data?.participantDemographics?.length ? (
      data.participantDemographics.map((demo, index) => (
        <div key={index} className="flex items-center gap-3"> {/* Changed to gap-3 for consistent spacing */}
          <div 
          ...
          <div className="flex-1 min-w-0 overflow-hidden"> {/* Added overflow-hidden */}
            <div className="flex justify-between items-center mb-2 gap-2"> {/* Added gap-2 */}
              <span 
              ...
              <span className="text-sm font-bold text-orange-700 flex-shrink-0 px-1"> {/* Added flex-shrink-0 and padding */}
                {demo.count}
              </span>
            </div>
